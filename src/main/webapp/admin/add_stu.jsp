		...
		<div id="wrap">
			<div id="top_content">
				...
				<div id="content">
					<p id="whereami"></p>
					<h1>添加学生</h1>
					<form action="<%=request.getServletContext().getContextPath()%>/addstu" method="post">
						<table cellpadding="0" cellspacing="0" border="0"
							class="form_table">
							<tr>
								<td valign="middle" align="right">学号：</td>
								<td valign="middle" align="left"><input type="text"
									class="inputgri" name="snumber" />
								</td>
							</tr>
							<tr>
								<td valign="middle" align="right">姓名：</td>
								<td valign="middle" align="left"><input type="text"
									class="inputgri" name="sname"  />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td valign="middle" align="left"><input type="text"
									class="inputgri" name="profession"/>
								</td>
							</tr>
						</table>
						<p>
