			...
			<div id="top_content"> 
				...
				<div id="content">
					...
					<table class="table">
						...
						<%
						List<Stu_Info> users=(List<Stu_Info>)request.getAttribute("stu_lists");
						for(int i=0;i<users.size();i++){
							...
							<tr class="row<%=i%2+1%>">
								...
								<td><a href="<%=request.getServletContext().getContextPath()%>/delstu?snumber=<%=user.getSnumber()%>">删除</a></td>
							</tr>
							<%
						}
						%>
